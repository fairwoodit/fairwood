class Walkathon::PaymentsController < ApplicationController
  ...
  before_action :set_walkathon_pledge, only: [:create]
  ...
  def create
    ...
    respond_to do |format|
      if payment_saved
        format.html { redirect_to walkathon_pledge_payments_path, notice: 'Payment was successfully created.' }
  ...
  def destroy
    # TODO: Fix this if we want to support payment deletion.
    @walkathon_payment.destroy
    respond_to do |format|
      format.html { redirect_to walkathon_payments_url, notice: 'Payment was successfully destroyed.' }
